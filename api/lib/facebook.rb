...
FB_OAUTH_URL = "https://www.facebook.com/dialog/oauth?client_id=#{FB_APP_ID}" +
               "&redirect_uri=http://localhost:3000/omniauth/authenticate_facebook&scope=email,read_stream,user_videos,publish_stream"

FB_ADD_OAUTH_URL = "https://www.facebook.com/dialog/oauth?client_id=#{FB_APP_ID}" +
                   "&redirect_uri=http://localhost:3000/me/facebook/authenticate_account&scope=email,read_stream,user_videos,publish_stream"
